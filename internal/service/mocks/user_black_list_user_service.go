...
// UserBlackListUserService is an autogenerated mock type for the UserBlackListUserService type
type UserBlackListUserService struct {
	mock.Mock
}

// AllBannedUsers provides a mock function with given fields: ctx
func (_m *UserBlackListUserService) AllBannedUsers(ctx context.Context) ([]userblacklist.UsersBlackList, error) {
	ret := _m.Called(ctx)
...
func (_m *UserBlackListUserService) BlockUser(ctx context.Context, dto userblacklist.BlockUserDTO) (userblacklist.UsersBlackList, error) {
...
func (_m *UserBlackListUserService) Exists(ctx context.Context, telegramID string) (bool, error) {
...
func (_m *UserBlackListUserService) UnblockUser(ctx context.Context, telegramID string) (string, error) {
	ret := _m.Called(ctx, telegramID)
...
// NewUserBlackListUserService creates a new instance of UserBlackListUserService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewUserBlackListUserService(t interface {
	mock.TestingT
	Cleanup(func())
}) *UserBlackListUserService {
	mock := &UserBlackListUserService{}
	mock.Mock.Test(t)
