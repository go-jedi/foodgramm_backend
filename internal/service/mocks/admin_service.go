...
func (_m *AdminService) AddAdminUser(ctx context.Context, telegramID string) (admin.Admin, error) {
...
func (_m *AdminService) ExistsByTelegramID(ctx context.Context, telegramID string) (bool, error) {
	ret := _m.Called(ctx, telegramID)
