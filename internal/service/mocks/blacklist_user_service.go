...
// BlacklistUserService is an autogenerated mock type for the BlacklistUserService type
type BlacklistUserService struct {
	mock.Mock
}

// AllBannedUsers provides a mock function with given fields: ctx
func (_m *BlacklistUserService) AllBannedUsers(ctx context.Context) ([]userblacklist.UsersBlackList, error) {
	ret := _m.Called(ctx)
...
func (_m *BlacklistUserService) BlockUser(ctx context.Context, dto userblacklist.BlockUserDTO) (userblacklist.UsersBlackList, error) {
...
func (_m *BlacklistUserService) Exists(ctx context.Context, telegramID string) (bool, error) {
...
func (_m *BlacklistUserService) UnblockUser(ctx context.Context, telegramID string) (string, error) {
	ret := _m.Called(ctx, telegramID)
...
// NewBlacklistUserService creates a new instance of BlacklistUserService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBlacklistUserService(t interface {
	mock.TestingT
	Cleanup(func())
}) *BlacklistUserService {
	mock := &BlacklistUserService{}
	mock.Mock.Test(t)
