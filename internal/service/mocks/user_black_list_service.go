...
// UserBlackListService is an autogenerated mock type for the UserBlackListService type
type UserBlackListService struct {
	mock.Mock
}

// AllBannedUsers provides a mock function with given fields: ctx
func (_m *UserBlackListService) AllBannedUsers(ctx context.Context) ([]userblacklist.UsersBlackList, error) {
	ret := _m.Called(ctx)
...
func (_m *UserBlackListService) BlockUser(ctx context.Context, dto userblacklist.BlockUserDTO) (userblacklist.UsersBlackList, error) {
...
func (_m *UserBlackListService) Exists(ctx context.Context, telegramID string) (bool, error) {
...
func (_m *UserBlackListService) UnblockUser(ctx context.Context, telegramID string) (string, error) {
	ret := _m.Called(ctx, telegramID)
...
// NewUserBlackListService creates a new instance of UserBlackListService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewUserBlackListService(t interface {
	mock.TestingT
	Cleanup(func())
}) *UserBlackListService {
	mock := &UserBlackListService{}
	mock.Mock.Test(t)
