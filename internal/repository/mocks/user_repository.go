...
import (
	...
	user "github.com/go-jedi/foodgramm_backend/internal/domain/user"
)
...
func (_m *UserRepository) Create(ctx context.Context, dto user.CreateDTO) (user.User, error) {
...
func (_m *UserRepository) DeleteByID(ctx context.Context, id int64) (int64, error) {
...
func (_m *UserRepository) DeleteByTelegramID(ctx context.Context, telegramID string) (string, error) {
...
func (_m *UserRepository) Exists(ctx context.Context, telegramID string, username string) (bool, error) {
...
func (_m *UserRepository) ExistsByID(ctx context.Context, userID int64) (bool, error) {
...
func (_m *UserRepository) ExistsByTelegramID(ctx context.Context, telegramID string) (bool, error) {
	ret := _m.Called(ctx, telegramID)
...
// ExistsExceptCurrent provides a mock function with given fields: ctx, id, telegramID, username
func (_m *UserRepository) ExistsExceptCurrent(ctx context.Context, id int64, telegramID string, username string) (bool, error) {
	ret := _m.Called(ctx, id, telegramID, username)
	...
	if rf, ok := ret.Get(0).(func(context.Context, int64, string, string) (bool, error)); ok {
		return rf(ctx, id, telegramID, username)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, string, string) bool); ok {
		r0 = rf(ctx, id, telegramID, username)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, int64, string, string) error); ok {
		r1 = rf(ctx, id, telegramID, username)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *UserRepository) GetByID(ctx context.Context, userID int64) (user.User, error) {
	ret := _m.Called(ctx, userID)
...
func (_m *UserRepository) GetByTelegramID(ctx context.Context, telegramID string) (user.User, error) {
	ret := _m.Called(ctx, telegramID)
...
func (_m *UserRepository) List(ctx context.Context, dto user.ListDTO) (user.ListResponse, error) {
	ret := _m.Called(ctx, dto)
...
func (_m *UserRepository) Update(ctx context.Context, dto user.UpdateDTO) (user.User, error) {
	ret := _m.Called(ctx, dto)
