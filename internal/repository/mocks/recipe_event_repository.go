...
// RecipeEventRepository is an autogenerated mock type for the RecipeEventRepository type
type RecipeEventRepository struct {
	mock.Mock
}

// All provides a mock function with given fields: ctx
func (_m *RecipeEventRepository) All(ctx context.Context) ([]recipeevent.Recipe, error) {
	ret := _m.Called(ctx)
...
func (_m *RecipeEventRepository) AllByTypeID(ctx context.Context, typeID int64) ([]recipeevent.Recipe, error) {
...
func (_m *RecipeEventRepository) Create(ctx context.Context, dto recipeevent.CreateDTO) (recipeevent.Recipe, error) {
...
func (_m *RecipeEventRepository) DeleteByID(ctx context.Context, recipeID int64) (int64, error) {
...
func (_m *RecipeEventRepository) GetByID(ctx context.Context, recipeID int64) (recipeevent.Recipe, error) {
	ret := _m.Called(ctx, recipeID)
...
func (_m *RecipeEventRepository) Update(ctx context.Context, dto recipeevent.UpdateDTO) (recipeevent.Recipe, error) {
	ret := _m.Called(ctx, dto)
...
// NewRecipeEventRepository creates a new instance of RecipeEventRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRecipeEventRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *RecipeEventRepository {
	mock := &RecipeEventRepository{}
	mock.Mock.Test(t)
