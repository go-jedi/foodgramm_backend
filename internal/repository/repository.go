...
type PromoCodeRepository interface {
	Create(ctx context.Context, dto promocode.CreateDTO) error
	Apply(ctx context.Context, telegramID string) error
	Check(ctx context.Context, telegramID string) error
}
