...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/client_assets": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Image file to upload (supported types: PNG, JPEG)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "201": {
                        "description": "Successfully uploaded file, returns file information",
                        "schema": {
                            "$ref": "#/definitions/clientassets.ClientAssets"
                        }
                    },
                    "400": {
                        "description": "Bad request if no file provided or unsupported file type",
                        "schema": {
                            "$ref": "#/definitions/clientassets.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error if file processing fails",
                        "schema": {
                            "$ref": "#/definitions/clientassets.ErrorResponse"
                        }
                    }
        ...
        "/v1/recipe_types": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Recipe type update data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/recipetypes.UpdateDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Updated recipe type details",
                        "schema": {
                            "$ref": "#/definitions/recipetypes.RecipeTypes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/recipetypes.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Recipe type data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/recipetypes.CreateDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/recipe_types/id/{recipeTypeID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Recipe type details",
                        "schema": {
                            "$ref": "#/definitions/recipetypes.RecipeTypes"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "ID of the deleted recipe type",
                        "schema": {
                            "type": "integer"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/userblacklist.UsersBlackList"
                            }
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/userblacklist.ErrorResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/v1/user/blacklist/block": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Block user data",
                        "name": "blockUser",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userblacklist.BlockUserDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/user/blacklist/exists/{telegramID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Indicates if the user exists in the blacklist",
                        "schema": {
                            "type": "boolean"
                        }
                    },
        ...
        "/v1/user/blacklist/unblock/{telegramID}": {
            "delete": {
